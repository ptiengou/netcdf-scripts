...
## JEANZAY    IDRIS ##
######################
#SBATCH --job-name=job_create_nf_201805          # Job Name
#SBATCH --output=job_outputs_errors/output_create_nf_era5_201805        # standard output
#SBATCH --error=job_outputs_errors/error_create_nf_era5_201805        # error output
#SBATCH --nodes=1
#SBATCH --exclusive
#SBATCH --ntasks=1   # Number of MPI tasks
#SBATCH --hint=nomultithread         # 1 processus MPI par par physical core (no hyperthreading) 
#SBATCH --time=01:30:00                # Wall clock limit (minutes)
